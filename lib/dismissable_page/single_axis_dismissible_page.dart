...
class SingleAxisDismissiblePage extends StatefulWidget {
  const SingleAxisDismissiblePage({
    ...
    required this.allowMultiPointer,
...
class _SingleAxisDismissiblePageState extends State<SingleAxisDismissiblePage>
  ...
  bool get _isPauseGesture =>
      widget.isPauseGesture || (_isMultiPointer && !widget.allowMultiPointer);
  ...
  Widget build(BuildContext context) {
    return CustomGestureDetector(
      onPointerChanged: (pointerCount) {
        setState(() {
          _isMultiPointer = pointerCount > 1;
        });
      },
      ...
      onVerticalDragStart:
          _isPauseGesture || _directionIsXAxis ? null : _handleDragStart,
      onVerticalDragUpdate:
          _isPauseGesture || _directionIsXAxis ? null : _handleDragUpdate,
      onVerticalDragEnd:
          _isPauseGesture || _directionIsXAxis ? null : _handleDragEnd,
