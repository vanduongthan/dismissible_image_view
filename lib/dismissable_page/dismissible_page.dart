...
import 'package:dismissible_image_view/custom_gesture_detector.dart';
...
/// Widget này cho phép vuốt xuống hoặc vuốt ngang để tắt bằng 1 ngón tay theo 1 hướng dọc hoặc ngang,
/// chưa xử lý cho trường hợp vuốt theo nhiều hướng (DismissiblePageDismissDirection.Multi)
...
class DismissiblePage extends StatelessWidget {
  ...
  ///Tạm dừng tất cả cử chỉ
  final bool isPauseGesture;

  ///Cho phép vuốt bằng nhiều ngón tay, nếu giá trị là false thì sẽ chỉ có thể dismiss page bằng cử chỉ 1 ngón tay
  final bool allowMultiPointer;
  ...
  Widget build(BuildContext context) {
    ...
    return ScrollConfiguration(
      ...
      child: SingleAxisDismissiblePage(
        ...
        hitTestBehavior: hitTestBehavior,
        contentPadding: contentPadding,
        isPauseGesture: isPauseGesture,
        allowMultiPointer: allowMultiPointer,
        child: child,
      ),
    );
  }
