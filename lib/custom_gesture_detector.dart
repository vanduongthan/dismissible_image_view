...
///
/// {@tool dartpad}
/// This example contains a black light bulb wrapped in a [CustomGestureDetector]. It
...
///
/// {@tool dartpad}
/// This example uses a [Container] that wraps a [CustomGestureDetector] widget which
/// detects a tap.
///
/// Since the [CustomGestureDetector] does not have a child, it takes on the size of its
...
/// ### Troubleshooting
///
/// Why isn't my parent [CustomGestureDetector.onTap] method called?
///
/// Given a parent [CustomGestureDetector] with an onTap callback, and a child
...
///
/// Setting [CustomGestureDetector.behavior] to [HitTestBehavior.opaque]
...
///
/// {@tool dartpad}
/// This example uses a [CustomGestureDetector] that wraps a green [Container] and a second
...
///
/// Changing the [CustomGestureDetector.behavior] property to [HitTestBehavior.translucent]
...
class CustomGestureDetector extends StatelessWidget {
  ...
  ///Trả về số ngón tay chạm trên màn hình
  final Function(int)? onPointerChanged;
  ...
  Widget build(BuildContext context) {
    ...
    return RawGestureDetector(
      ...
      child: child,
      onPointerChanged: onPointerChanged,
    );
  }
...
/// factories.
///
/// For common gestures, use a [CustomGestureDetector].
...
/// See also:
///
///  * [CustomGestureDetector], a less flexible but much simpler widget that does the same thing.
...
class RawGestureDetectorState extends State<RawGestureDetector> {
  ...
  void _handlePointerDown(PointerDownEvent event) {
    _pointerCount++;
    widget.onPointerChanged?.call(_pointerCount);
    assert(_recognizers != null);
    for (final GestureRecognizer recognizer in _recognizers!.values) {
...
///
/// It is used to allow custom [CustomGestureDetector]s to add semantics notations.
